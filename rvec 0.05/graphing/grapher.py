...
class info_settings:
    ...
    def __init__(self,graph_type=1,bgcolor=settings["bgcolor"],color=settings["color"], plot_x=settings["plot_x"], plot_y=settings["plot_y"], scatter_x=scatter_points["x"], scatter_y=scatter_points["y"]):
...
class Window:
    ...
    def __init__(cls,settings=settings):
        ...
        cls.scatter_x = scatter_points["x"]
        cls.scatter_y = scatter_points["y"]
        ...
        if cls.settings["graph_type"] == 0:
            try:
                for i in range(len(x)):
                    ...
                    x_ratio = (500/cls.plot_x)
                    y_ratio = (500/cls.plot_y)
                    cls.main.goto((x[i]*x_ratio+(0))+1, (y[i]*y_ratio+(0))+1)
                    cls.main.pendown()
                    cls.main.goto((x[i]*x_ratio+(0)), (y[i]*y_ratio+(0)))
            except:
                pass
        else:
            pass
...
#setfunc("(0.02301587*(x**5))+(-0.21388889*(x**4))+(0.45079365*(x**3))+(0.39722222*(x**2))+(-0.0047619*(x))+(-7.10542736*(10**-15))")
#setfunc("6*(x)+(-7)")
#setfunc("(0.1107042886360432)+((12.199747704042238)*(x**1))+((-4.2032757793713245)*(x**2))+((0.8241540575945692)*(x**3))+((-0.0756191956756993)*(x**4))+((0.002612708449589718)*(x**5))")
#setfunc("(6)*(x)+(-7)")

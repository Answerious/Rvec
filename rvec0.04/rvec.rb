...
require_relative('./rvecbase/subcorrarr')
require_relative('./rvecbase/multicorrarr')
require_relative('./rvecbase/divcorrarr')
require_relative('./rvecbase/errornum')
require_relative('./rvecbase/helpercommands')
require_relative('./rvecbase/numeric')
require_relative('./rvecbase/conv')
...
#puts(print(Rvec.regx([1,2,3,4],[1,4,9,16])))